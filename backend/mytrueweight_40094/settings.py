"""
Django settings for mytrueweight_40094 project.
...
ROOT_URLCONF = 'mytrueweight_40094.urls'
...
WSGI_APPLICATION = 'mytrueweight_40094.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mytrueweight_40094 API",
    "DESCRIPTION": "API documentation for mytrueweight_40094 App",
    "VERSION": "v1",
}
